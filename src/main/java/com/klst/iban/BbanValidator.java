...
public class BbanValidator {
    ...
    static {
    	...
    	BBAN_DATA.put("AZ", new BbanValidator("([A-Z]{4})([A-Z0-9]{20})"           )); //N4!a20!c
    	...
    	BBAN_DATA.put("BG", new BbanValidator("([A-Z]{4})(\\d{4})([A-Z0-9]{10})", 1)); //S4!a4!n2!n8!c +BranchCode Kontrollzeichen+account
    	BBAN_DATA.put("BH", new BbanValidator("([A-Z]{4})([A-Z0-9]{14})"           )); //N4!a14!c
    	BBAN_DATA.put("BR", new BbanValidator("(\\d{8})(\\d{5})([A-Z0-9]{12})"  , 1)); // 8!n5!n10!n1!a1!c +BranchCode account+Kontrollzeichen
    	BBAN_DATA.put("BY", new BbanValidator("([A-Z0-9]{4})(\\d{4})([A-Z0-9]{16})", 1)); //N4!c4!n16!c +BranchCode
    	...
    	BBAN_DATA.put("DO", new BbanValidator("([A-Z0-9]{4})(\\d{20})"             )); //N4!c20!n
    	...
    	BBAN_DATA.put("GB", new BbanValidator("([A-Z]{4})(\\d{6})(\\d{8})"      , 1)); //S4!a6!n8!n +BranchCode
    	BBAN_DATA.put("GE", new BbanValidator("([A-Z]{2})(\\d{16})"                )); // 2!a16!n
    	BBAN_DATA.put("GG", new BbanValidator("([A-Z]{4})(\\d{6})(\\d{8})"      , 1)); //S4!a6!n8!n +BranchCode, included in GB
    	BBAN_DATA.put("GI", new BbanValidator("([A-Z]{4})([A-Z0-9]{15})"           )); //S4!a15!c
    	...
    	BBAN_DATA.put("GT", new BbanValidator("([A-Z0-9]{4})([A-Z0-9]{20})"        )); //N4!c20!c
    	...
    	BBAN_DATA.put("IE", new BbanValidator("([A-Z]{4})(\\d{6})(\\d{8})"      , 1)); //S4!a6!n8!n +BranchCode
    	BBAN_DATA.put("IL", new BbanValidator("(\\d{3})(\\d{3})(\\d{13})"       , 1)); // 3!n3!n13!n +BranchCode
    	BBAN_DATA.put("IM", new BbanValidator("([A-Z]{4})(\\d{6})(\\d{8})"      , 1)); //S4!a6!n8!n +BranchCode, included in GB
    	BBAN_DATA.put("IQ", new BbanValidator("([A-Z]{4})(\\d{3})(\\d{12})"     , 1)); //N4!a3!n12!n +BranchCode
    	...
    	BBAN_DATA.put("JE", new BbanValidator("([A-Z]{4})(\\d{6})(\\d{8})"      , 1)); //S4!a6!n8!n +BranchCode, included in GB
    	BBAN_DATA.put("JO", new BbanValidator("([A-Z]{4})(\\d{4})([A-Z0-9]{18})", 1)); //N4!a4!n18!c +BranchCode (nicht bei iban.com)
    	BBAN_DATA.put("KW", new BbanValidator("([A-Z]{4})([A-Z0-9]{22})"           )); //N4!a22!c
    	BBAN_DATA.put("KZ", new BbanValidator("(\\d{3})([A-Z0-9]{13})"             )); // 3!n13!c
    	BBAN_DATA.put("LB", new BbanValidator("(\\d{4})([A-Z0-9]{20})"             )); // 4!n20!c
    	BBAN_DATA.put("LC", new BbanValidator("([A-Z]{4})([A-Z0-9]{24})"           )); //N4!a24!c
    	...
    	BBAN_DATA.put("LV", new BbanValidator("([A-Z]{4})([A-Z0-9]{13})"           )); //S4!a13!c
    	...
    	BBAN_DATA.put("MT", new BbanValidator("([A-Z]{4})(\\d{5})([A-Z0-9]{18})", 1)); //S4!a5!n18!c + BranchCode
    	BBAN_DATA.put("MU", new BbanValidator("([A-Z]{4})(\\d{2})([A-Z0-9]{20})", 1)); //N4!a2!n2!n12!n3!n3!a +BranchCode account+Kontrollzeichen (Großbuchstabe oder Ziffer)
    	BBAN_DATA.put("NL", new BbanValidator("([A-Z]{4})(\\d{10})"                )); //S4!a10!n
    	BBAN_DATA.put("NO", new BbanValidator("(\\d{4})(\\d{7})"                   )); // 4!n6!n1!n
    	BBAN_DATA.put("PK", new BbanValidator("([A-Z]{4})([A-Z0-9]{16})"           )); //N4!a16!c
    	BBAN_DATA.put("PL", new BbanValidator("(\\d{8})(\\d{16})"                  )); // 8!n16!n
    	BBAN_DATA.put("PS", new BbanValidator("([A-Z]{4})([A-Z0-9]{21})"           )); //N4!a21!c
    	...
    	BBAN_DATA.put("QA", new BbanValidator("([A-Z]{4})([A-Z0-9]{21})"           )); //N4!a21!c
    	BBAN_DATA.put("RO", new BbanValidator("([A-Z]{4})([A-Z0-9]{16})"           )); //S4!a16!c
    	BBAN_DATA.put("RS", new BbanValidator("(\\d{3})(\\d{15})"                  )); // 3!n13!n2!n
    	BBAN_DATA.put("SA", new BbanValidator("(\\d{2})([A-Z0-9]{18})"             )); // 2!n18!c
    	BBAN_DATA.put("SC", new BbanValidator("([A-Z]{4})([A-Z0-9]{23})"           )); //N4!a2!n2!n16!n3!a BankCode:4!a2!n2!n iban.com nur 4!a account+Kontrollzeichen+sonstige
    	...
    	BBAN_DATA.put("SV", new BbanValidator("([A-Z]{4})(\\d{20})"                )); //N4!a20!n
    	...
    	BBAN_DATA.put("VG", new BbanValidator("([A-Z]{4})(\\d{16})"                )); //N4!a16!n
